...
export default class Milestone extends React.Component {
    ...
    componentDidMount() {
        this.props.MilestoneActions.retrieveMilestone(
                            ...
                            {reports.map(report => {
                                ...
                                return (
                                    <div className="card">
                                        ...
                                        {typeof report.last_deadline_met ==
                                        'boolean' ? (
                                            <div>
                                                <p>
                                                    <strong>
                                        ...
                                        {typeof report.deliverable_satisfaction ==
                                        'boolean' ? (
                                            <div>
                                                <strong>
                                        ...
                                        {typeof report.next_deadline_meet ==
                                        'boolean' ? (
                                            <div>
                                                <strong>
                                        ...
                                        {/* General */}
                                        {typeof report.pm_communication ==
                                        'boolean' ? (
                                            <div>
                                                <strong>
                                        ...
                                        report.user.id == getUser().id ? (
                                            <button
                                                className="btn "
                                                onClick={this.onEditReport.bind(
                                                    this,
                                                )}>
