                ...
                <Col {...colProps}>
                    <div className="card">
                        ...
                        {invoices.length?(
                            <div>
                                <div>
                                    Next payment for <Link to={`/projects/${invoices[0].project.id}/pay/`}>{invoices[0].project.title}: {invoices[0].title}</Link> is {moment.utc() > moment.utc(invoices[0].due_at)?'overdue by':'due in'}:
                                </div>
